...
export const Logo: React.FC<LogoProps> = ({
  ...
  <svg
    className={cx(
      styles.logo,
      styles[size],
      { [styles.solidRings]: size === 'xs' || size === 'sm', [styles.glitch]: glitch },
      className
    )}
    version="1.1"
    viewBox={renderText ? '0 0 698 675.19' : '0 0 560 582.4'}
    xmlns="http://www.w3.org/2000/svg"
    aria-label="Harlem Line Hustle"
    role="img"
  >
    {renderText && (
      <g>
        <path
          ...
          d="M42.85,617V661.2H34.14V643.26H14.4V661.2H5.7V617h8.7v17.82H34.14V617Z"
        />
        <path
          className={styles.text}
        ...
        />
        <path className={styles.text} d="M137.18,617h8.7V652.8h20.76v8.4H137.18Z" />
        <path
          className={styles.text}
          d="M175.64,617h30.12v8.4H184.34v9.42h19v8.4h-19v9.54H206.6v8.4h-31Z"
        />
        <path
          className={styles.text}
          d="M215.61,661.2v-46h.06L240.21,650l-3.72-.84,24.48-34h.12v46h-8.7V634.86l.54,4.5L238,660.6h-.12l-15.36-21.24,1.5-4.14v26Z"
        />
        <path className={styles.text} d="M292,617h8.7V652.8h20.76v8.4H292Z" />
        <path className={styles.text} d="M330.46,617h8.7V661.2h-8.7Z" />
        <path
          className={styles.text}
        ...
        <path
          className={styles.text}
          d="M401.75,617h30.12v8.4H410.45v9.42h19v8.4h-19v9.54h22.26v8.4h-31Z"
        />
        <path
          className={styles.text}
          d="M498.36,617V661.2h-8.7V643.26H469.92V661.2h-8.71V617h8.71v17.82h19.74V617Z"
        />
        <path
          className={styles.text}
        ...
        <path
          className={styles.text}
          d="M587.11,617h29.76v8.4H606.13V661.2h-8.7V625.44H587.11Z"
        />
        <path className={styles.text} d="M625.27,617H634V652.8h20.77v8.4H625.27Z" />
        <path
          className={styles.text}
          d="M663.74,617h30.12v8.4H672.44v9.42h19v8.4h-19v9.54H694.7v8.4h-31Z"
        />
      </g>
    )}
    <path className={cx(styles.ring, styles.inner)} d="M481.2,366.9a158.53,158.53,0,1,0-264,.5" />
    <path
      className={cx(styles.ring, styles.middle)}
      d="M481.2,446A212.61,212.61,0,0,0,562,279c0-117.6-95.4-213-213-213S136,161.4,136,279a212.36,212.36,0,0,0,81.2,167.3"
    />
    <path
      className={cx(styles.ring, styles.outer)}
    ...
    <g className={styles.train}>
      <path d="M464,249.2a31.92,31.92,0,0,0-31.9-31.9H265.9A31.92,31.92,0,0,0,234,249.2V372.4H464ZM340.4,340.8a15.62,15.62,0,0,1-15.6,15.6H271a15.62,15.62,0,0,1-15.6-15.6V252.1A15.62,15.62,0,0,1,271,236.5h53.7a15.62,15.62,0,0,1,15.6,15.6v88.7Zm103,0a15.62,15.62,0,0,1-15.6,15.6H374a15.62,15.62,0,0,1-15.6-15.6V252.1A15.62,15.62,0,0,1,374,236.5h53.7a15.62,15.62,0,0,1,15.6,15.6v88.7Z" />
      <rect x="234" y="378.4" width="230" height="19.8" />
      <path d="M440.1,466.4h-.5a32,32,0,0,0,24.7-31.1V404.2h-230v31.1A31.94,31.94,0,0,0,259,466.4h-.8l-90,116h45l13-20h246l12,20h46Zm-34.8-46.9A12.5,12.5,0,1,1,392.8,432,12.5,12.5,0,0,1,405.3,419.5Zm-113,0A12.5,12.5,0,1,1,279.8,432,12.5,12.5,0,0,1,292.3,419.5Zm-10.6,47.8h133l13.5,21.2h-158Zm-39.6,68.1,11-19h191l12,19Z" />
    </g>
  </svg>
);
