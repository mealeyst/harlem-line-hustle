...
export const fontFamilyValues: {[key in FontFamily]: string} = {
  [FontFamily.HEADER]: '\'Josefin Sans\', sans-serif',
...
@import url('https://fonts.googleapis.com/css2?family=Josefin+Sans:ital,wght@0,400;0,700;1,400;1,700&family=Raleway:ital,wght@0,400;0,700;1,400;1,700&display=swap');
`
