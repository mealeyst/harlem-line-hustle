...
export const attachment = (key: BACKGROUND_ATTACHMENT): string => {
  return `background-attachment: ${background.attachment[key]};`
}

export const clip = (key: BACKGROUND_CLIP): string => {
...
export const image = (url: string): string => {
  return `background-image: url(${url});`
}

export const position = (key: BACKGROUND_POSITION): string => {
  return `background-position: ${background.position[key]};`
}

export const repeat = (key: BACKGROUND_REPEAT): string => {
  return `background-repeat: ${background.repeat[key]};`
}

export const size = (key: BACKGROUND_SIZE) => {
